 ...
 */
public class DontShowNotificationPropertyTest extends TestCase {

	private DontShowNotificationProperty property;
	...
	protected void setUp() throws Exception {
		super.setUp();
		property = new DontShowNotificationProperty( "desc", "label" );
	}
